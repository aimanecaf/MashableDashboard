                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    html.H6(
                                        children=["Comparison between methods : From this table, we can notice that Random Forest is the best method with a predictive power of 66%. We must also recognize parametric methods for their particular advantages and their close proximity to this value of 66%."], 
                                        className="subtitle padded"
                                    ),
                                    html.Img(
                        src=app.get_asset_url("methods.png"),
                        className="row",
                    ),
                                ],
                            ),
html.Div(
                                ...
                                children=[
                                    html.H6(
                                        "Key Performance Indicators for the best method (Random Forest) : Generally, there was a small improvement in the level of the Accuracy with 66%. The area under the curve is up to 71% which indicates that the model is quite satisfactory.",
                                        className="subtitle padded",
                                    ),
                                    html.Div(
                                        className='column',
                                    ...
                                    html.Div(
                                        ...
                                        children=[
                                            html.H2("71 %"),
                                            html.H6('Area Under the curve (AUC)')
                                        ]
                                    ),
                                ],
                            ),
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    html.H6(
                                        "The most important variables for the random forest algorithm are those related to keyword, the days between the article publication and the dataset acquisition, closeness to top 5 LDA, Avg. shares of referenced articles in Mashable topics and Text subjectivity. The content creator, the journalist can play on these variables to increase the probability of articles popularity.",
                                        className="subtitle padded",
                                    ),
                                    html.Img(
                        src=app.get_asset_url("result.png"),
